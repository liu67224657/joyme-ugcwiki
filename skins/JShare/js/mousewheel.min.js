...
(function(e) {
    ...
    e.fn.perfectScrollbar = function(o, r) {
        return this.each(function() {
            ...
            var l, s, c, a, i, p, u, f, d = e(this).addClass("ps-container"),
                h = e("<div class='ps-scrollbar-x'></div>").appendTo(d),
                v = e("<div class='ps-scrollbar-y'></div>").appendTo(d),
                g = parseInt(h.css("bottom"), 10),
                m = parseInt(v.css("right"), 10),
                b = function() {
                    var e = parseInt(f * (a - s) / (s - u), 10);
                    d.scrollTop(e), h.css({
                        bottom: g - e
                    })
                },
                ...
                L = function() {
                    ...
                    h.css({
                        left: p + d.scrollLeft(),
                        bottom: g - d.scrollTop(),
                        width: i
                    }), v.css({
                        top: f + d.scrollTop(),
                        right: m - d.scrollLeft(),
                        height: u
                    })
                },
                D = function() {
                    l = d.width(), s = d.height(), c = d.prop("scrollWidth"), a = d.prop("scrollHeight"), c > l ? (i = T(parseInt(l * l / c, 10)), p = parseInt(d.scrollLeft() * (l - i) / (c - l), 10)) : (i = 0, p = 0, d.scrollLeft(0)), a > s ? (u = T(parseInt(s * s / a, 10)), f = parseInt(d.scrollTop() * (s - u) / (a - s), 10)) : (u = 0, f = 0, d.scrollTop(0)), f >= s - u && (f = s - u), p >= l - i && (p = l - i), L()
                },
                I = function(e, t) {
                    var o = e + t,
                        r = l - i;
                ...
                x = function() {
                    var t, o;
                    v.bind("mousedown.perfect-scroll", function(e) {
                        o = e.pageY, t = v.position().top, v.addClass("in-scrolling"), e.stopPropagation(), e.preventDefault()
                    }), e(document).bind("mousemove.perfect-scroll", function(e) {
                        v.hasClass("in-scrolling") && (b(), C(t, e.pageY - o), e.stopPropagation(), e.preventDefault())
                    }), e(document).bind("mouseup.perfect-scroll", function() {
                ...
                P = function() {
                    ...
                    d.bind("mousewheel.perfect-scroll", function(t, o, r, l) {
                        d.scrollTop(d.scrollTop() - l * n.wheelSpeed), d.scrollLeft(d.scrollLeft() + r * n.wheelSpeed), D(), e(r, l) && t.preventDefault()
                ...
                S = function() {
                    var t = function(e, t) {
                            d.scrollTop(d.scrollTop() - t), d.scrollLeft(d.scrollLeft() - e), D()
                        },
                        o = {},
                        r = 0,
                        n = {},
                ...
                X = function() {
                    h.remove(), v.remove(), d.unbind(".perfect-scroll"), e(window).unbind(".perfect-scroll"), d.data("perfect-scrollbar", null), d.data("perfect-scrollbar-update", null), d.data("perfect-scrollbar-destroy", null)
                },
                Y = function(t) {
                    ...
                    var o = function() {
                            ...
                            d.bind("mouseenter.perfect-scroll", t).bind("mouseleave.perfect-scroll", o), h.bind("mouseenter.perfect-scroll", t).bind("mouseleave.perfect-scroll", o), v.bind("mouseenter.perfect-scroll", t).bind("mouseleave.perfect-scroll", o)
                        },
                        r = function() {
                            L = function() {
                                h.css({
                                    ...
                                    right: m,
                                    height: u
                                }), h.hide().show(), v.hide().show()
                            }, b = function() {
                                var e = parseInt(f * a / s, 10);
                                d.scrollTop(e), h.css({
                                    bottom: g
                                }), h.hide().show()
                            }, w = function() {
                                var e = parseInt(p * c / l, 10);
                                d.scrollLeft(e), v.hide().show()
                            }
                        };
                    6 === t && (o(), r())
                },
                ...
                E = function() {
                    ...
                    e && "msie" === e[1] && Y(parseInt(e[2], 10)), D(), y(), x(), M && S(), d.mousewheel && P(), d.data("perfect-scrollbar", d), d.data("perfect-scrollbar-update", D), d.data("perfect-scrollbar-destroy", X)
                };
            return E(), d
        })
    }
    ...
    function t(t) {
        var o = t || window.event,
            ...
            l = 0,
            s = 0;
        return t = e.event.fix(o), t.type = "mousewheel", o.wheelDelta && (n = o.wheelDelta / 120), o.detail && (n = -o.detail / 3), s = n, void 0 !== o.axis && o.axis === o.HORIZONTAL_AXIS && (s = 0, l = -1 * n), void 0 !== o.wheelDeltaY && (s = o.wheelDeltaY / 120), void 0 !== o.wheelDeltaX && (l = -1 * o.wheelDeltaX / 120), r.unshift(t, n, l, s), (e.event.dispatch || e.event.handle).apply(this, r)
    }
    var o = ["DOMMouseScroll", "mousewheel"];
    if (e.event.fixHooks) for (var r = o.length; r;) e.event.fixHooks[o[--r]] = e.event.mouseHooks;
