...
//     if ($(window).width() > 991) {
//         //maodian_pc();
//         $('.download-pc .close').click(function(){
//             $(this).parents('.download-pc').hide();
//         })
...
//             //超过一屏显示回到顶部but
//             // alert(1);
//             var scrollTop = -$('#wrapper').offset().top;
...
$(function(){
    ...
    $('.comment-box').on('click','.zan',function(e){
