 ...
 * @ingroup Skins
 */
class SkinJShare extends SkinTemplate {

    public $skinname        = 'jshare';
    public $stylename       = 'jshare';
    public $template        = 'JShareTemplate';
    ...
    public function initPage(OutputPage $out) {
        ...
        $out->addModuleScripts('skins.jshare');
    }
   ...
   function setupSkinUserCss( OutputPage $out ) {
        ...
        $styles = array( 'mediawiki.skinning.interface', 'skins.jshare','ext.socialprofile.userinfo.css' );
 ...
 * @ingroup Skins
 */
class JShareTemplate extends BaseTemplate {
    ...
    public function execute() {
        ...
        echo '<script type="text/javascript" src="http://static.joyme.'.$wgEnv.'/mobile/cms/apparticledetail/js/commentcommon.js"></script>';
        ?>
        ...
        <div id="bigwrapper" class="bigwrapper"><div>
        
        <div class="download-pc">
           <div class="main-download">
               <div class="left-d">
                   
                   <span class="font-1 marleft">着迷WIKI</span>
                   <span class="font-2 marleft">专注游戏百科</span>
               </div>
               <div class="right-d">
                   <p>下载App，随时查攻略</p>
                   <div class="erwei"></div>
		    ...
		    <button type="button" class="header-search"></button>
                    <div id="sidebar-menu-bg" class="mengceng-share" class="display:none"></div>
                            ...
                            <div class="ysw-wiki" >
                                ...
                                <a href="http://wanba.joyme.com/" class="support-ask"></a>
                            </div>
...
//            include 'view/Modal.php'; ?>
				...
				<div class="share-right">
                    <a target="_blank" href="http://wanba.joyme.com/" class="erwei-ma"></a>
        ...
        <?php $this->printTrail(); ?>
        <?php $this->renderShare($this->data['title']); ?>
        </body>
        </html><?php
        wfRestoreWarnings();
    }
    ...
    private function renderShare($title)
    {
//        global ;
        $html = '
        <div id="_sharebtn_status" style="display: none;">NO</div>
        <div id="unikey" style="display: none;"></div>
        <div id="domian" style="display: none;"></div>
        <div id="_title" style="display: none;"></div>
        <div id="_desc" style="display: none;"></div>
        <div id="_clientpic" style="display: none;"></div>
        <div id="_share_url" style="display: none;"></div>
        <div id="_share_task" style="display: none;"></div>
        <div id="_url" style="display: none;"></div>
        <div id="_ptime" style="display: none;"></div>
        <div id="_ctype" style="display: none;"></div>
        <div id="_unikey" style="display: none;"></div>
        <div id="_shoucang_status" style="display: none;"></div>
        <div id="_wikikey" style="display: none;"></div>
