...
;var postComment = (function(){
    ...
    var pageHandler={
       ...
       /* setTitle:function(){
            ...
            if(_title=='首页'){
                _title = $('#_discussion').text();
            }else{
                _title = 'WIKI文章'
            }
            _jclient.setTitle && _jclient.setTitle(_title)
        },*/
        PCorM:function(){
            ...
            this.comment = new Commentjs({
                ...
                scrollObj:{
                    initEl:$('#wrapper'),
                    innerEl:$('.joymewiki-content-block'),
                    scroll:this.scroll,
                }
            })
        ...
        bindEvent:function(){
            ...
            this.scroll.on('touchend', function (pos) {
              ...
              //   }, 1000)
              // }
              var documentH = $('.joymewiki-content-block').height();
        ...
        toTop:function(){
            ...
            this.weichat.find('.go-top').click(function(e){
                e.preventDefault();
    ...
    // $(function(){
    //    console.log(pageHandler,pageHandler['comment']); 
    // })
    return function(obj){
        $(function(){
            console.log(pageHandler,pageHandler['comment']); 
           pageHandler.comment.commentRelease(obj)
        })
        // pageHandler.comment.commentRelease(obj)
