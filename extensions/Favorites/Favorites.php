...
$wgResourceModules['ext.favorites.js'] = array(
	'scripts' => array('/modules/favorites.js'),
	'dependencies' => array(
				'mediawiki.api',
		'user.tokens'),
...
$wgResourceModules['ext.favorites'] = array(
		'scripts' => array('/modules/favoriteslist.js'),
		'dependencies' => array(
				'mediawiki.api',
		'user.tokens'),
		'localBasePath' => __DIR__,
...
$wgResourceModules['ext.favorites.style'] = array(
		'styles' => array('/modules/like-list.css'),
...
$wgAutoloadClasses['FavoriteListAPI'] = $dir . '/api/FavoriteList.api.php';
$wgAPIModules['favoritelist'] = 'FavoriteListAPI';
